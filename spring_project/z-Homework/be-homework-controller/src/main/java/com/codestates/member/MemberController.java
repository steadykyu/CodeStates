...
public class MemberController {
    ...
    @PatchMapping("/{member-id}") //HTTP 메서드를 PATCH로 받음. PATCH URI/{phone-id}
    public ResponseEntity patchPhone(@PathVariable("member-id") long memberId,// ID값을 받아옴
                                     @RequestParam("phone") Object phone){ // 요청의 body값을 받아옴.
