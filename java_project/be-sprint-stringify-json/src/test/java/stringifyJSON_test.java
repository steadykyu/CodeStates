...
public class stringifyJSON_test {
    ...
    @Test
    @DisplayName("Integer 타입을 입력받을 경우, 알맞은 형태의 JSON으로 변환합니다")
    public void Boolean_타입의_입력을_JSON으로_변경합니다_3() throws JsonProcessingException {
        assertThat(test.stringify(10)).isEqualTo(ObjectMapper(10));
    }
    ...
    public void 배열을_입력받았을_경우_JSON으로_변경합니다_4() throws JsonProcessingException {
        assertThat(test.stringify(new Object[]{8, "hi", true})).isEqualTo(ObjectMapper(new Object[]{8, "hi",true}));
    }
